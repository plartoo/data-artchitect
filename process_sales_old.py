...
def main():
    ...
    tables_and_script = {
        ...
        'incampaign_websales_zipcode': [['python', ROOT_FOLDER+'run_vsql.py', ROOT_FOLDER+'process_websales.sql'],
                                        ['python', ROOT_FOLDER+'archive_files.py', 'FilesForDatamart/WebSales/', S3_ARCHIVE_ROOT+'WebSales/'],
                                        ['python', ROOT_FOLDER+'run_vsql_and_export_to_s3.py', ROOT_FOLDER+'export_websales.sql',
                                         'WebSales/', 'FilesForDatamart/WebSales/', 'websales']],
        'incampaign_storesales_zipcode': [['python', ROOT_FOLDER+'run_vsql.py', ROOT_FOLDER+'process_storesales.sql'],
                                          ['python', ROOT_FOLDER+'archive_files.py', 'FilesForDatamart/StoreSales/', S3_ARCHIVE_ROOT+'StoreSales/'],
                                          ['python', ROOT_FOLDER+'run_vsql_and_export_to_s3.py', ROOT_FOLDER+'export_storesales.sql',
